...
function renderSidebar(q=''){
  ...
  for(const el of ELEMENTS){
    if(qq && !(el.name.toLowerCase().includes(qq) || el.symbol.toLowerCase().includes(qq) || (el.family && el.family.toLowerCase().includes(qq)))) continue;
    const row = document.createElement('div'); row.className = 'element'; row.draggable = true;
